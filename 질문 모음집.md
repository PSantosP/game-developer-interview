...
> 포크 확장: [Unreal 클라이언트 기술면접 질문 모음집](./Unreal%20%ED%81%B4%EB%9D%BC%EC%9D%B4%EC%96%B8%ED%8A%B8%20%EA%B0%9C%EB%B0%9C%EC%9E%90%20%EA%B8%B0%EC%88%A0%EB%A9%B4%EC%A0%91%20%EB%8C%80%EB%B9%84%20%EC%A7%88%EB%AC%B8%20%EB%AA%A8%EC%9D%8C%EC%A7%91.md#toc) · [C++·Unreal 기초 실습](./README.md#study-questions) · [통합 README](./README.md#목차)
...
[Unity에서 할당을 줄이는 습관](./README.md#unity%EC%97%90%EC%84%9C-%ED%95%A0%EB%8B%B9%EC%9D%84-%EC%A4%84%EC%9D%B4%EB%8A%94-%EC%8A%B5%EA%B4%80)에
...
[읽기 자료: 32비트 vs. 64비트 운영체제](./README.md#32%EB%B9%84%ED%8A%B8-vs-64%EB%B9%84%ED%8A%B8-%EC%9A%B4%EC%98%81%EC%B2%B4%EC%A0%9C)<br>
[읽기 자료: 가상 메모리](./README.md#%EA%B0%80%EC%83%81-%EB%A9%94%EB%AA%A8%EB%A6%AC)<br>
[읽기 자료: Stack / Heap Memory](./README.md#stack--heap-memory)<br>
[읽기 자료: Memory Fragmentation](./README.md#memory-fragmentation)<br>
[읽기 자료: C#과 Unity의 Garbage Collector](./README.md#c%EA%B3%BC-unity%EC%9D%98-garbage-collector)
...
* Unity 씬에 놓인 오브젝트가 디바이스 화면에 그려지기까지의 연산 과정을 설명하세요.
  * [읽기 자료: 그래픽 렌더링 파이프라인](./README.md#%EA%B7%B8%EB%9E%98%ED%94%BD-%EB%A0%8C%EB%8D%94%EB%A7%81-%ED%8C%8C%EC%9D%B4%ED%94%84%EB%9D%BC%EC%9D%B8)에서
...
[읽기 자료: 그래픽 렌더링 파이프라인](./README.md#%EA%B7%B8%EB%9E%98%ED%94%BD-%EB%A0%8C%EB%8D%94%EB%A7%81-%ED%8C%8C%EC%9D%B4%ED%94%84%EB%9D%BC%EC%9D%B8)<br>
[읽기 자료: 드로우 콜 최적화](./README.md#%EB%93%9C%EB%A1%9C%EC%9A%B0-%EC%BD%9C-%EC%B5%9C%EC%A0%81%ED%99%94)<br>
[읽기 자료: 배치 렌더링](./README.md#%EB%B0%B0%EC%B9%98-%EB%A0%8C%EB%8D%94%EB%A7%81)<br>
[읽기 자료: 스프라이트 아틀라스](./README.md#%EC%8A%A4%ED%94%84%EB%9D%BC%EC%9D%B4%ED%8A%B8-%EC%95%84%ED%8B%80%EB%9D%BC%EC%8A%A4)<br>
😎 [읽기 자료: 텍스처 압축 포맷](./README.md#%ED%85%8D%EC%8A%A4%EC%B2%98)
...
* [읽기 자료: C#과 Unity의 `null`](./README.md#c%EA%B3%BC-unity%EC%9D%98-null)에서
  C++ 네이티브 객체와 `System.Object` 객체와 `UnityEngine.Object` 객체에 대해 설명하는 부분이 있는데, 해당 설명이 옳은 설명인지 검증하세요.

* `is null`과 `== null`의 차이에 대해 설명해 보세요.

* 🔨 어떤 `GameObject`의 관리 참조가 null인지와 엔진 객체가 유효한지를 구분하여 판정하는 방법을 코드로 작성하여 설명해 보세요.
...
[읽기 자료: C#과 Unity의 `null`](./README.md#c%EA%B3%BC-unity%EC%9D%98-null)<br>
[읽기 자료: Null Object 패턴](./README.md#null-object-패턴)<br>
[읽기 자료: 빈 문자열 확인](./README.md#%EB%B9%88-%EB%AC%B8%EC%9E%90%EC%97%B4-%ED%99%95%EC%9D%B8)<br>
...
* 🔨 Unity에서 사용자에게 팝업 UI를 띄우고 팝업 안의 버튼을 누를 때까지 기다렸다가 버튼이 눌린 후에
  ...
  4. 출력하는 `Action` callback(continuation)을 메서드의 인자로 넘기기  
     힌트: [읽기 자료: `delegate` & `event`](./README.md#delegate--event)
...
[읽기 자료: 프로세스 vs. 스레드](./README.md#%ED%94%84%EB%A1%9C%EC%84%B8%EC%8A%A4-vs-%EC%8A%A4%EB%A0%88%EB%93%9C)<br>
[읽기 자료: Mutex & Semaphore](./README.md#mutex--semaphore)<br>
[읽기 자료: Deadlock (교착 상태)](./README.md#deadlock-%EA%B5%90%EC%B0%A9-%EC%83%81%ED%83%9C)<br>
[읽기 자료: Coroutine vs. 비동기 프로그래밍 vs. UniTask vs. Awaitable](./README.md#coroutine-vs-%EB%B9%84%EB%8F%99%EA%B8%B0-%ED%94%84%EB%A1%9C%EA%B7%B8%EB%9E%98%EB%B0%8D-vs-unitask-vs-awaitable)
...
[읽기 자료: Unity 성능 최적화](./README.md#unity-%EC%84%B1%EB%8A%A5-%EC%B5%9C%EC%A0%81%ED%99%94)<br>
[읽기 자료: Unity에서 할당을 줄이는 습관](./README.md#unity%EC%97%90%EC%84%9C-%ED%95%A0%EB%8B%B9%EC%9D%84-%EC%A4%84%EC%9D%B4%EB%8A%94-%EC%8A%B5%EA%B4%80)<br>
[읽기 자료: C# `struct`와 `class` 인스턴스의 차이](./README.md#c-struct%EC%99%80-class-%EC%9D%B8%EC%8A%A4%ED%84%B4%EC%8A%A4%EC%9D%98-%EC%B0%A8%EC%9D%B4)<br>
[읽기 자료: C# Boxing & Unboxing](./README.md#c-boxing--unboxing)<br>
[읽기 자료: C# `string`](./README.md#c-string)<br>
[읽기 자료: `delegate` & `event`](./README.md#delegate--event)<br>
[읽기 자료: Lambda, Anonymous Method & Closure](./README.md#lambda-anonymous-method--closure)
...
[읽기 자료: Unity 프로파일러](./README.md#unity-%ED%94%84%EB%A1%9C%ED%8C%8C%EC%9D%BC%EB%9F%AC)<br>
[읽기 자료: 렌더링 성능 최적화 (Unity docs)](https://docs.unity3d.com/kr/2021.3/Manual/OptimizingGraphicsPerformance.html)  
[읽기 자료: 드로우 콜 최적화](./README.md#%EB%93%9C%EB%A1%9C%EC%9A%B0-%EC%BD%9C-%EC%B5%9C%EC%A0%81%ED%99%94)<br>
[읽기 자료: Mip Map & LOD](./README.md#mip-map--lod)<br>
[읽기 자료: 텍스처 압축 포맷](./README.md#%ED%85%8D%EC%8A%A4%EC%B2%98)<br>
...
* 💯😎 `virtual` 메서드가 있는 부모 클래스 A와 이를 상속한 클래스 B가 있고 B에서 A의 메서드를 `override`했을 때, 이 두 메서드의 주소가 메모리에서 어떤 자료구조로 관리되나요?
...
[읽기 자료: 네 가지 속성](./README.md#%EB%84%A4-%EA%B0%80%EC%A7%80-%EC%86%8D%EC%84%B1)<br>
[읽기 자료: 5원칙 (SOLID 원칙)](./README.md#5원칙-solid-원칙)<br>
[읽기 자료: interface vs. abstract class](./README.md#interface-vs-abstract-class)<br>
[읽기 자료: Dependency Injection 패턴](./README.md#dependency-injection)<br>
...
😎 [읽기 자료: C# VTable](./README.md#c-vtable)<br>
...
[읽기 자료: Unity Addressable](./README.md#unity-addressable)<br>
...
* 😎📊 데이터 형식·크기·플랫폼 요구를 정하고 JSON과 다른 직렬화 라이브러리의 장단점을 비교해 보세요.
...
[읽기 자료: OSI 7계층](./README.md#osi-7%EA%B3%84%EC%B8%B5)<br>
[읽기 자료: 멀티플레이어 게임의 구조](./README.md#%EB%A9%80%ED%8B%B0%ED%94%8C%EB%A0%88%EC%9D%B4%EC%96%B4-%EA%B2%8C%EC%9E%84%EC%9D%98-%EA%B5%AC%EC%A1%B0)<br>
[읽기 자료: 원격 프로시저 호출 (RPC)](./README.md#%EC%9B%90%EA%B2%A9-%ED%94%84%EB%A1%9C%EC%8B%9C%EC%A0%80-%ED%98%B8%EC%B6%9C-rpc)<br>
[읽기 자료: Unity Serialization / Deserialization](./README.md#unity-serialization--deserialization)<br>
...
* 💯 Reflection의 사용을 지양해야 하는 이유가 무엇인가요?
  * [읽기 자료: C# Reflection](./README.md#c-reflection)에
...
[읽기 자료: C# LINQ](./README.md#c-linq)<br>
[읽기 자료: C# Reflection](./README.md#c-reflection)
